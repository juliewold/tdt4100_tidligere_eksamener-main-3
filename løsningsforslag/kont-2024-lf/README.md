...
* [Del 1](src/main/java/com/shopstore/retail/part1/README.md) (20%) - BMW vil sikre at du har god forståelse for Java-programmeringsspråket. De har laget 10 Java-programmeringsspørsmål for å teste kunnskapen din.
* [Del 2](src/main/java/com/shopstore/retail/part2/README.md) (20%) - I denne delen skal du implementere en klasse og metoder for en bilfabrikk og hovedkontor.
* [Del 3](src/main/java/com/shopstore/retail/part3/README.md) (20%) - I denne oppgaven skal du implementere et globalt kjøretøyidentifikasjonsnummer (VIN)-register og en bilproduksjonslinje.
* [Del 4](src/main/java/com/shopstore/retail/part4/README.md) (20%) - I denne delen skal du implementere metoder for å lese og skrive filer.
* [Del 5](src/main/java/com/shopstore/retail/part5/README.md) (20%) - I denne delen skal du implementere observer/observable-mønsteret, tilpassede unntak og delegering.
