...
* [Del 1](src/main/java/com/shopstore/retail/part1/README.md) (20%) - BMW vil sikra at du har god forståing for Java-programmeringsspråket. Dei har laga 10 Java-programmeringsspørsmål for å testa kunnskapen din.
* [Del 2](src/main/java/com/shopstore/retail/part2/README.md) (20%) - I denne delen skal du implementera ein klasse og metodar for ein bilfabrikk og hovudkontor.
* [Del 3](src/main/java/com/shopstore/retail/part3/README.md) (20%) - I denne oppgåva skal du implementera eit globalt køyretøyidentifikasjonsnummer (VIN)-register og ei bilproduksjonslinje.
* [Del 4](src/main/java/com/shopstore/retail/part4/README.md) (20%) - I denne delen skal du implementera metodar for å lesa og skriva filer.
* [Del 5](src/main/java/com/shopstore/retail/part5/README.md) (20%) - I denne delen skal du implementera observer/observable-mønsteret, tilpassa unntak og delegering.
