...
public class TransactionLogWriter {
    ...
    public static void writeTransactions(List<TransactionRecord> transactions, OutputStream outputStream) throws IOException {
        ...
        // The try-with-resources statement will close the writer, which would close the underlying stream.
        // To avoid closing the stream, we manually flush the writer.
