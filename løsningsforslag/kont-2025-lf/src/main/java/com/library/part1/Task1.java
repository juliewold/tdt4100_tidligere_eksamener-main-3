...
public class Task1 {
     ...
     * 
     * LF: Both alt 1 and alt 4 are correct,
     * but alt 1 is more specific to the task of parsing an integer.
     * Therefore, alt 1 is the best choice for safely parsing an integer from a string.
     */
    ...
    public static void main(String[] args) {
        ...
        System.out.println(safeParseInt(null, -1)); // Should print -1
    }
}
