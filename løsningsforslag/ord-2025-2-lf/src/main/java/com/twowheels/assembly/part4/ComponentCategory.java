...
public class ComponentCategory {
    ...
    private Collection<IBikeComponent> components = new HashSet<>();
    ...
    public boolean isDescendantOf(ComponentCategory componentCategory) {
        ...
        if (parent == componentCategory) {
            return true;
        }
        return parent.isDescendantOf(componentCategory);
    }
    ...
    public void removeChildCategory(ComponentCategory componentCategory) {
        ...
        if (!children.contains(componentCategory)) {
            throw new IllegalArgumentException("Category is not a direct childCategory");
        }
        children.remove(componentCategory);
        componentCategory.parent = null;
    }
    ...
    public Collection<IBikeComponent> getAllComponents() {
        ...
        Collection<IBikeComponent> allComponents = new HashSet<>(components);
        for (ComponentCategory childCategory : children) {
            allComponents.addAll(childCategory.getAllComponents());
        }
