...
Testene som følger med her er ment å teste spesifikke deler av oppførselen til metodene. I enkelte tilfeller har vi vært klar over mangler ved testene, som har vært spesifisert i sensurveiledningen for sensor. 
Det betyr at selv om alle testene er rett, kan det være ting ved besvarelsen som gjør at den ikke får 100 % på en del. 

Mer strukturelle tester vi kjører som f.eks tester om koden er korrekt innkapslet ligger ikke ved her. 
