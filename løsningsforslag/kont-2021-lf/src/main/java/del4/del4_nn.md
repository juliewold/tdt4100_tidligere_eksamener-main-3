...
Fyll inn vedlagde [Temperature](Temperature.java). Temperature har oversyn over ein temperatur som enten er i Fahrenheit eller i Celisus. 

Temperature har følgjande metodar:

- *Temperature(double degrees, char scale)* - Opprettar eit **Temperature*-objekt med ein skala (Fahrenheit/Celsisus) og eit tal grader
