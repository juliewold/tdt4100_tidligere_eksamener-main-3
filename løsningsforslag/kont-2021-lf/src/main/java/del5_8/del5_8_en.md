...
- *bidReceived(String bidder, int bid)* - Creates a new **Bid** and registers this and notifies listener about the new bid dependent on whether it's the highest bid or not. 
...
- *setComission(double comission)* Updates the broker's process
