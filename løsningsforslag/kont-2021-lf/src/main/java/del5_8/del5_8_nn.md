...
Fyll ut nødvendige metodar og felt for å støtta lytting i [Property](Property.java) klassen, for å gjera det mogleg og lytta på nye bod på eigedommen. Følgjande metodar skal implementerast: 
...
- *bidReceived(String bidder, int bid)* - Opprettar eit nytt **Bid** og registrerer dette, og seier ifrå til alle lyttarane om eit nytt bod er komne
...
Implmenter metodane i [Realtor](Realtor.java)

- *Realtor(double comission)* opprettar eit **Realtor** objekt med ein gitt provisjon
- *setComission(double comission)* Oppdaterer prosjonen til meklaren
