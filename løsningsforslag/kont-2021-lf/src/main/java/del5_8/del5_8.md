...
Fyll ut nødvendige metoder og felt for å støtte lytting i [Property](Property.java) klassen, for å gjøre det mulig og lytte på nye bud på eiendommen. Følgende metoder skal implementeres: 
...
Implmenter metodene i [Realtor](Realtor.java)

- *Realtor(double comission)* oppretter et **Realtor** objekt med en gitt provisjon
- *setComission(double comission)* Oppdaterer prosjonen til megleren
